                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 px-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-primary"  name="Save" id="Save" value="do">Approved</button>
                                                    </div>
                                                </div>
                                        ...
                                        <?php
                                             ...
                                             if(isset($_POST["Save"])){
                                               ...
                                               $sign = $_POST['sign'];
                                                ...
                                                //      }
                                                //      mysqli_close($conn);
                                                $sql_insert = mysqli_query($con, "INSERT INTO approved(delivery_to,id,job_no,bme,equipment,dept,pre_maintenance,repair,decontaminate,position,date,time,contact,sign) VALUES ('$delivery_to','$id','$job_no','$bme','$equipment','$dept','$pre_maintenance','$repair','$decontaminate','$position','$date','$time','$contact','$sign')");
                                                  if($sql_insert){
